...
public class Comparison {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 두개의 항 중 어느 것이 더 큰지, 더 작은지, 같은지, 다른지의 여부를 판단한다.
		 비교 연산자의 결과값은 참(true) 또는 거짓(false)으로 반환한다.
		...
		System.out.println(p==q); // 값이 다르기 때문에 false 반환.
		boolean isEqual = p==q;
		...
		boolean isEqual1 = p!=q; // p와 q의 값이 다르게 나오기 때문에 true 반환.
		System.out.println(isEqual1);
		
		boolean isEqual2 = p!=r; // p와 r의 값이 같게 나오기 때문에 false 반환.
