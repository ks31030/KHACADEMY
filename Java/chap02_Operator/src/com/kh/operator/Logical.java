...
public class Logical {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 &&(논리 AND), ||(논리 OR), !(논리 NOT)
		 &&(논리곱) 두 항이 모두 참인 경우 참, 아니면 거짓. ex) boolean val = (5>2) && (5>3); 
		 ||(논리합) 두 항 중 하나의 항이라도 참이면 참. ex) boolean val = (5>2) || (5<3); //true
		 !(부정) 참인 경우는 거짓으로 바꾸고, 거짓인 경우는 참으로 바꿈. ex) boolean val = !(5>2); //false
		*/
		/*boolean isTrue = true;
