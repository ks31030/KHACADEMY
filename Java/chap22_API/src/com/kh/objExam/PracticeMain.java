 ...
 * */
	...
	public void practice1() {
		...
		System.out.println("첫번째 문자열의 해시코드 : " + hashCode1);
		System.out.println("두번째 문자열의 해시코드 : " + hashCode2);
		
		//문자열의 문자열 표현 출력
		String str1String = str1.toString();
		String str2String = str2.toString();
		System.out.println("첫번째 문자열의 문자열 표현 : " + str1String);
		System.out.println("두번째 문자열의 문자열 표현 : " + str2String);
	}
